...
let oldTab = userTab;
const API_KEY = "4a5c0df29312471698b121840230307";
const API_KEY_ONLY_FLAG = "d1845658f92b31c64bd94f06f7188c9c";
...
async function fetchUserWeatherInfo(coordinates) {
  ...
  try {
    const response = await fetch(
      `http://api.weatherapi.com/v1/current.json?key=${API_KEY}&aqi=no&q=${lat},${lon}`
    );
...
function renderWeatherInfo(weatherInfo) {
  ...
  countryIcon.src = `https://flagcdn.com/144x108/${"IN".toLowerCase()}.png`;
